...
#define CMD_CONFGPIO10              0xb1  // sets the direction of the GPIO4 or GPIO5 pin
#define CMD_SETGPIO10               0xb2  // sets the value on GPIO4 or GPIO5 pin
#define CMD_GETGPIO10               0xb3  // gets the value from GPIO4 or GPIO5 pin 
